...
export function BuildInPublic() {
  const photos = [
    ...
    { src: "/images/_MG_4281.JPG", alt: "On Stage Moments" },
    { src: "/images/_MG_4282.JPG", alt: "Answering Jury Questions" },
    { src: "/images/_MG_4286.JPG", alt: "Spendora Showcase" },
    { src: "/images/_MG_4287.JPG", alt: "Networking with Mentors" },
    { src: "/images/_MG_4288.JPG", alt: "Live Demonstration" },
    { src: "/images/_MG_4301.JPG", alt: "E-Summit 2025" },
    { src: "/images/_MG_4312.JPG", alt: "Award Recognition" },
    { src: "/images/IMG_9667.JPG", alt: "Hackathon Pitch Session" },
    { src: "/images/IMG_7760.jpg", alt: "Building in Public" },
  ];
